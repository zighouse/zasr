...
void PrintUsage(const char* program_name) {
  ...
  std::cout << "  --vad-threshold <value>    VAD threshold (0.0-1.0, default: 0.5) [sense-voice only]\n";
  std::cout << "  --min-silence-duration <s> Minimum silence duration in seconds (default: 0.1) [sense-voice only]\n";
  ...
  std::cout << "\n";
  std::cout << "  --vad-window-size-ms <ms> VAD window size in milliseconds (default: 30) [sense-voice only]\n";
